...
/**
 * 
 * 名称：FlowWFGRMXXX01.java
 * <p>功能：单位下个人明细账查询 <br> 
 * @author 王赫
 * @version 0.1	2018年7月18日	王赫创建
 */
@Component
public class FlowWFGRMXXX01 implements FlowHelperI {

	private static final Logger logger = LoggerFactory.getLogger(FlowWFGRMXXX01.class);
	...
	*/
	...
	public String cmd(String stepid, String task, MainContext mainContext) {
		if("GRMXZCX".equals(task)){
			TransEngine.getInstance().execute("TranGRMXXX01",mainContext);
		}
		return null;
	}
