 ...
 * 名称：FlowWFZJCZJL02
  ...
  */
@Component
public class FlowWFZJCZJL02 implements FlowHelperI {

	private static final Logger logger = LoggerFactory.getLogger(FlowWFZJCZJL02.class);
	
	private static final String STEP_STEP1="step1";//单位最近操作记录
