 ...
 */
@Component
public class FlowWFXHTQ01 implements FlowHelperI {

	private static final Logger logger = LoggerFactory.getLogger(FlowWFXHTQ01.class);
	
	private static final String STEP_STEP1="step1";//销户提取
	...
	*/
	...
	public String cmd(String stepid, String task, MainContext mainContext) {
		...
		else if ("jstqje".equals(task)) {
			pool.put("flag", "jstqje");
			HashMap<String, Object> ret = TransEngine.getInstance().execute("TranXHTQ01", mainContext);
			return JsonUtil.getJsonString(ret);
		}
		return null;
	}
	...
	private boolean out_step1(MainContext mainContext){
        ...
        // 提交销户提取信息
        pool.put("flag", "tjxx");
		TransEngine.getInstance().execute("TranXHTQ01", mainContext);
		// 业务编号
