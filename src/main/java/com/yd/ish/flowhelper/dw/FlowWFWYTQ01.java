 ...
 */
@Component
public class FlowWFWYTQ01 implements FlowHelperI {

	private static final Logger logger = LoggerFactory.getLogger(FlowWFWYTQ01.class);
	
	private static final String STEP_STEP1="step1";//物业费提取
	...
	*/
	...
	public String cmd(String stepid, String task, MainContext mainContext) {
		...
		// 计算可提取金额
			...
			HashMap<String, Object> ret = TransEngine.getInstance().execute("TranWYTQ01", mainContext);
			return JsonUtil.getJsonString(ret);
		}
		return null;
	}
	...
	private boolean out_step1(MainContext mainContext){
		...
		// 提交物业费提取信息
		pool.put("flag", "tjxx");
		TransEngine.getInstance().execute("TranWYTQ01", mainContext);
