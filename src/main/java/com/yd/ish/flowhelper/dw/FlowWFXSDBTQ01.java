 ...
 * <p>功能： 享受低保提取
 * @author 柏慧敏
 * @version 0.1	2019年10月16日	柏慧敏创建
 * @note
 */
@Component
public class FlowWFXSDBTQ01 implements FlowHelperI {

	private static final Logger logger = LoggerFactory.getLogger(FlowWFXSDBTQ01.class);
	
	private static final String STEP_STEP1="step1";//享受低保提取
	...
	*/
	...
	public String cmd(String stepid, String task, MainContext mainContext) {
		...
		// 计算可提取金额
			...
			HashMap<String, Object> ret = TransEngine.getInstance().execute("TranXSDBTQ01", mainContext);
			return JsonUtil.getJsonString(ret);
		}
		return null;
	}
	...
	private boolean out_step1(MainContext mainContext){
		...
		// 提交享受低保提取信息
		pool.put("flag", "tjxx");
		TransEngine.getInstance().execute("TranXSDBTQ01", mainContext);
