...
import com.yd.svrplatform.util.JsonUtil;
 ...
 /**
 * 名称：FlowWFGMZZZF01
 * <p>功能：购买自住住房提取流程助手<br>
 * @author 柏慧敏
 * @version 0.1	2018年7月16日	柏慧敏创建
 * @note	
 */
@Component
public class FlowWFGMZZZF01 implements FlowHelperI {

	private static final Logger logger = LoggerFactory.getLogger(FlowWFGMZZZF01.class);
	
	private static final String STEP_STEP1="step1";//购买自住住房
	...
	*/
	...
	private boolean out_step1(MainContext mainContext){
		...
		TransEngine.getInstance().execute("TranGMZZZF01",mainContext);
