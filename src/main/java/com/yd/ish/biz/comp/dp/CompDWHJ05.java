...
/**
 * 名称：CompDWHJ05.java
 * <p>功能：单位汇缴-获取单位最近一笔汇缴信息 <br>
 *
 * @author 许永峰
 * @version 0.1    2019年11月26日	许永峰创建
 */
@Component("CompDWHJ05")
public class CompDWHJ05 extends BaseComp {

    private static final Logger logger = LoggerFactory.getLogger(CompDWHJ05.class);
    ...
    public int execute() {
        ...
        /*入口参数赋值结束*/
        //开始调用接口BSP_DP_HQZJHJXX_01获取单位最近汇缴信息
        logger.info("[-] 调用BSP_DP_HQZJHJXX_01接口开始");
        XmlResObj data = super.sendExternal("BSP_DP_HQZJHJXX_01");
        ...
        logger.info("[-] 调用BSP_DP_HQZJHJXX_01接口结束");
