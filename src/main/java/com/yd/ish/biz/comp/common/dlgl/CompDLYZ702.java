 ...
 * @note
 */
@Component("CompDLYZ702")
public class CompDLYZ702 extends BaseComp{

	private static final Logger logger = LoggerFactory.getLogger(CompDLYZ702.class);
	...
	public int execute() {
		...
		XmlResObj data =  super.sendExternal("BSP-OAPI-800",false);
