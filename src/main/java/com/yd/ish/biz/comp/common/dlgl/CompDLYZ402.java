...
/**
 * 名称：CompDLYZ401.java
 * <p>功能：登录功能-单点登录单位用户登录验证返回用户信息 <br> 
 * @author 许永峰
 * @version 0.1	2019年01月03日	许永峰创建
 */
@Component("CompDLYZ402")
public class CompDLYZ402 extends BaseComp{

	private static final Logger logger = LoggerFactory.getLogger(CompDLYZ402.class);

	private static final String INTERFACE_ID="BSP-OAPI-401";//调用的接口
