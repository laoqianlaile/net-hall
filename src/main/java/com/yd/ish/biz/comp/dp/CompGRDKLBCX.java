...
/**
 * 
 * 名称：CompGRDKLBCX.java
 * <p>
 * 功能：个人贷款列表查询 <br>
 *
 */
@Component("CompGRDKLBCX")
public class CompGRDKLBCX extends BaseComp {

	private static final Logger logger = LoggerFactory.getLogger(CompGRDKLBCX.class);
	...
	/** 数据分割符 */
	private static final String wjm = "个人贷款列表";
	/**核心返回文件编码格式*/
