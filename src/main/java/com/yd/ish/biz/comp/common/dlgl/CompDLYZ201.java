 ...
 *
 */
@Component("CompDLYZ201")
public class CompDLYZ201 extends BaseComp{

	private static final Logger logger = LoggerFactory.getLogger(CompDLYZ201.class);

	private static final String INTERFACE_ID="BSP-OAPI-200";//调用的接口
	...
	public int execute() {
	    ...
	    if (XmlResHead.TR_SUCCESS.equals(head.getParticular_code())){
			...
			//instname="指定机构";
			roleCodes="PER01001";
			BrcCode = body.get("BrcCode").toString();
		...
		setOutParam("BrcCode",BrcCode);//角色集合
    	/*出口参数赋值结束*/
