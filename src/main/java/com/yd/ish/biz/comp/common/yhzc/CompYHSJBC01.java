...
/**
 * 名称：CompYHSJBC01.java
 * <p>功能：个人用户升级保存信息 <br> 
 * @author 张洪超
 * @version 0.1	2017年9月21日	张洪超创建
 */
@Component("CompYHSJBC01")
public class CompYHSJBC01 extends BaseComp{

	private static final Logger logger = LoggerFactory.getLogger(CompYHSJBC01.class);
	
	private static final String INTERFACE_ID="BSP-OAPI-503";//调用用户升级的接口
	...
	public int execute() {
		...
		logger.info("[+]调用个人用户升级接口"+INTERFACE_ID+"开始");
	    ...
	    if (XmlResHead.TR_SUCCESS.equals(head.getParticular_code())){
	    	...
	    	logger.info("[-]调用个人用户升级接口"+INTERFACE_ID+"成功");
	    }else{
	    	logger.info("[-]调用个人用户升级接口"+INTERFACE_ID+"失败");
