 ...
 */
@Component("CompDLYZ302")
public class CompDLYZ302 extends BaseComp{

	private static final Logger logger = LoggerFactory.getLogger(CompDLYZ302.class);

	private static final String INTERFACE_ID="BSP-OAPI-301";//调用的接口
