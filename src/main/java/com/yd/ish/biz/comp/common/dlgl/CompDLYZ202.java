...
/**
 * 名称：CompDLYZ202.java
 * <p>功能：登录功能-个人刷脸用户登录验证返回用户信息 <br> 
 * @author 张洪超
 * @version 0.1	2017年8月31日	张洪超创建
 * 		   V0.2 2018年10月23日     柏慧敏修改    1.根据贯标信息项修改字段id 2.角色编码由detail标签中返回改为在body标签中返回
 */
@Component("CompDLYZ202")
public class CompDLYZ202 extends BaseComp{

	private static final Logger logger = LoggerFactory.getLogger(CompDLYZ202.class);

	private static final String INTERFACE_ID="BSP-OAPI-201";//调用的接口

	@Override
	public int execute() {

		/*入口参数赋值开始*/
		String certno=getString("certno");//身份证号或公积金账号
    	/*入口参数赋值结束*/
