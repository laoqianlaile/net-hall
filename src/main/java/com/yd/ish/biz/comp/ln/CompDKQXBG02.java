 ...
 * @note
 */
@Component("CompDKQXBG02")
public class CompDKQXBG02 extends BaseComp{

	private static final Logger logger = LoggerFactory.getLogger(CompDKQXBG02.class);
	/** 启用凭证系统标记 **/
	...
	public int execute() {
		...
		if(flag){
			...
			XmlResObj data = super.sendExternal("BSP_LN_DKQXBG_02");
