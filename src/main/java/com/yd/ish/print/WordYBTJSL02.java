...
/**
 * 
 * 名称：WordYBTJSL02.java
 * <p>功能： 异步提交示例打印<br> 
 * @author wanghe
 * @version 0.1	2018年4月16日	wanghe创建
 */
@Service
public class WordYBTJSL02 implements IYDVoucher {

	@Autowired
	ParamConfigImp paramConfigImp;
	@Autowired
	FlowAttachmentImp flowAttachmentImp;
	private static final Logger logger = LoggerFactory.getLogger(WordYBTJSL02.class);

	@Override
	public File generateVoucher(DataPool pool, int cs) {
		logger.debug("[+]-----异步提交示例打印");
		WordEngine wordEngine = new WordEngine("YBTJ_PZSL_02", pool.getString("_OPERID"));
		// 输出打印数据
