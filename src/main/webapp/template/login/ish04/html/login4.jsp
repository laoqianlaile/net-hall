...
<%
	final String LOGIN_TYPE_NAME = "密码登录（管理员）";
...
<div class="frame-main">
    ...
    <form action="#" id="form4" method="post" target="_parent">
        <div class="form-id-layer">
            <img src="../image/icon-user.png" alt="">
            <input type="text" id="dlyhm" name="dlyhm" placeholder="请输入用户名" autocomplete="off" value="1"/>
        </div>
        <div class="form-pass-layer">
            <img src="../image/icon-lock.png" alt="">
            <input type="password" id="dlmm" name="dlmm" placeholder="请输入密码" autocomplete="off" value="1" />
        </div>
...
<%--        <div class="form-verify" id="p_xyjmdzd" hidden="hidden">
        ...
        <input type="hidden" id="logintype" name="logintype" value="manager" />
...
$(function(){
	...
	$('form').on("keydown", function(event) {
		if (event.which == '13') {
//			loginCommon.login(options,$('#form4').serialize());
