...
function CreateXTXAppObject() {	
	...
	// modify by qiyangzhong
	    o.Base64Encode = function(InData, cb, ctx) {
        var ret = XTXAPP.SOF_Base64Encode(InData);
		return $myOKRtnFunc(ret, cb, ctx);
    }
	// modify by qiyangzhong end 
...
// modify by qiyangzhong
function Base64Encode(indata, cb, ctx) {
    if ($_$CurrentObj != null && $_$CurrentObj.VerifySignedHashData != undefined) {
		return $_$CurrentObj.Base64Encode(indata, cb, ctx);
	}
    return $myErrorRtnFunc("", cb, ctx);
}
// modify by qiyangzhong end
...
function Login(formName, strCertID, strPin, strAction) {
	...
	var a = VerifyUserPIN(strCertID, strPin, $loginVerifyPINCallBack, ctx);
...
function GetSzSignCert(strContainerName)
{  
