...
<%
	final String LOGIN_TYPE_NAME = "密码登录（开发人员）";
...
<div class="frame-main">
    ...
    <form action="#" id="form5" method="post" target="_parent">
...
<%--        <div class="form-verify" id="p_xyjmdzd" hidden="hidden">
        ...
        <input type="hidden" id="logintype" name="logintype" value="programmer" />
...
$(function(){
	...
	$('form').on("keydown", function(event) {
		if (event.which == '13') {
//			loginCommon.login(options,$('#form5').serialize());
            // 请求前校验处理
...
//		loginCommon.login(options,$('#form5').serialize());
        ...
        console.log(url,"<%= YdpxUtil.getContexPath() %>/RSA/rsaKey");
        $.ajax({
            type: 'post',
            url: "<%= YdpxUtil.getContexPath() %>/RSA/rsaKey",
            dataType: "json",
