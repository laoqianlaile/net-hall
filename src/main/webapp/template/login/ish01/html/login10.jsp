...
%><%
	final String LOGIN_TYPE_NAME = "密码登录（单位临时用户）";
...
<div class="frame-main">
	...
	<form action="#" id="form0" target="_parent">
		<div class="form-id-layer">
			...
			<input type="text" id="dlyhm" name="dlyhm" placeholder="请输入身份证号" autocomplete="off"/>
		</div>
		<div class="form-pass-layer">
			<img src="../image/icon-lock.png" alt="">
			<input type="password" id="dlmm" name="dlmm" placeholder="请输入登录密码" autocomplete="off" />
		</div>
		...
		<div class="form-href">
			<a href="<%= YdpxUtil.getContexPath() %>/flow/menu/WFYHZC02" target="_parent">用户注册</a>
			<a href="<%= YdpxUtil.getContexPath() %>/flow/menu/WFWJMA02" target="_parent">忘记密码</a>
		</div>
		<!-- 登录时用 -->
		<input type="hidden" id="logintype" name="logintype" value="orgtemp" />
