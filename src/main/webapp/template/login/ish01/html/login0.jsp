...
%><%
	final String LOGIN_TYPE_NAME = "密码登录（个人）";
...
<div class="frame-main">
    ...
    <form action="#" id="form0" target="_parent">
        <div class="form-id-layer">
            ...
            <input type="text" id="dlyhm" name="dlyhm" placeholder="请输入证件号码" autocomplete="off"/>
        </div>
        ...
        <div class="form-href">
            <a href="<%= YdpxUtil.getContexPath() %>/flow/menu/WFYHZC01" target="_parent">用户注册</a>
